...
class ComponentContainer extends React.Component {
  ...
  updateAxisColorGen(name){
    let updateColor = function (newSetting) {
      let newColorTheme = this.state.options
      newColorTheme["axisStyle"][name] = newSetting
      this.setState({options: newColorTheme})
    }
    return updateColor
  }
  ...
  updateLegendColorGen(name){
    let updateColor = function (newSetting) {
      let newColorTheme = this.state.options
      newColorTheme["legendStyle"][name] = newSetting
      this.setState({options: newColorTheme})
    }
    return updateColor
  }
  ...
  updateGraphStyleGen(name){
    let updateColor = function (newSetting) {
      let newColorTheme = this.state.options
      newColorTheme["graphStyle"][name] = newSetting
      this.setState({options: newColorTheme})
    }
    return updateColor
  }
