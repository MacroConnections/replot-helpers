  ...
  render() {
    ...
    for (var i=0; i < types.length; i++) {
      if (types[i] == this.props.switch) {
        color = ColorTheme[this.props.palette].buttonActive
        bgColor = ColorTheme[this.props.palette].buttonActive
      } else {
        color = ColorTheme[this.props.palette].button
        bgColor = ColorTheme[this.props.palette].buttonHover
      }
