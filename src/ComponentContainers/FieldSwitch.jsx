  ...
  render() {
    const style = {
      outer: {
        ...
        marginTop: "8px",
        backgroundColor: ColorTheme[this.props.palette].optionsField,
        borderRadius: "15px",
        marginLeft: "15px",
        marginRight: "15px",
        border: `1px solid ${ColorTheme[this.props.palette].optionsFieldBorder}`
      },
      input: {
        ...
        ":focus":{
          outline: "none",
          color: ColorTheme[this.props.palette].inputText
        }
      }
    }
